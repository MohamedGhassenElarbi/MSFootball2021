<template>
    <div>
        ...
        <div style="margin-left:350px;margin-right:440px;">
        ...
        <div class="flex justify-center ml-0">
            <button v-on:click="updateExercice" class="bg-blue-400 text-white rounded-md w-64 h-20 mt-12 text-3xl font-bold text-center focus:outline-none"> Valider</button>
        </div>
...
<script>
import headerMenu from '@/components/modificationExercice/header'
    export default {
        data () {
            return {
               creation:false,
        ...
        methods:{
            ...
            updateExercice(){
                ...
                this.$store.dispatch('updateExercice',this.exercice);              
            ...
            loadExercice(){
                let v = this.$store.getters.getExerciceParId(Number(this.valeur)); 
                this.exercice.id=v.id
                this.exercice.nom=v.nom
                this.exercice.theme=v.theme
                this.exercice.partie=v.partie
                this.exercice.phaseDeJeu=v.phaseDeJeu
                this.exercice.procede=v.procede
                this.exercice.pedagogie=v.pedagogie
                this.exercice.intensite=v.intensite
                this.exercice.recuperation=v.recuperation


                this.exercice.categorie=v.categorie
                this.exercice.difficulte=v.difficulte
                this.exercice.repos=v.repos
                this.exercice.nombreSeries=v.nombreSeries
                this.exercice.dureeEffort=v.dureeEffort
                this.exercice.duree=v.duree

                this.exercice.objectif=v.objectif
                this.exercice.consignes=v.consignes
                this.exercice.critere=v.critere
